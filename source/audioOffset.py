...
'''
A modified solution used in https://github.com/allisonnicoledeal/VideoSync
'''
...
def get_offset(path_to_audio1, path_to_audio2, fft_bin_size=1024, overlap=0, box_height=512, box_width=43, samples_per_box=7):
    # Process first file
    wavfile1 = path_to_audio1
...
#
'''
PATH_TO_UNALIGNED_AUDIO_SAMPLES = '../dataset/audioSamples/wavSamples/'
PATH_TO_ALIGNED_AUDIO_SAMPLES   = '../dataset/audioSamples/alignedWavSamples/'
aud1 = PATH_TO_UNALIGNED_AUDIO_SAMPLES + 'left (with a tablet).wav'
aud2 = PATH_TO_UNALIGNED_AUDIO_SAMPLES + 'right (with a phone).wav'

test = get_offset(aud1, aud2)
print(test)
'''